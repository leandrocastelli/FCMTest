...
import lcs.fcmtest.wizard.ui.ParentInfoFragment;

/**
 * A page asking for a name and an email.
 */
public class ParentInfoPage extends Page {
    public static final String NAME_DATA_KEY = "name";
    public static final String EMAIL_DATA_KEY = "email";

    public ParentInfoPage(ModelCallbacks callbacks, String title) {
        super(callbacks, title);
    }

    @Override
    public Fragment createFragment() {
        return ParentInfoFragment.create(getKey());
    }
